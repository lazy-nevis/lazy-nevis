...
describe("updates", () => {
  ...
  it("ignores drafts and returns a newer release", async () => {
    vi.stubGlobal("fetch", vi.fn().mockResolvedValue(new Response(JSON.stringify([
      ...
      { tag_name: "v0.1.0-rc.2", html_url: "https://github.com/lazy-nevis/lazy-nevis/releases/tag/v0.1.0-rc.2", draft: false, prerelease: true },
    ]), { status: 200 })));
  ...
  it("ignores prereleases for a stable installation", async () => {
    vi.stubGlobal("fetch", vi.fn().mockResolvedValue(new Response(JSON.stringify([
      { tag_name: "v0.2.0-rc.1", html_url: "https://github.com/lazy-nevis/lazy-nevis/releases/tag/v0.2.0-rc.1", draft: false, prerelease: true },
      { tag_name: "v0.1.0", html_url: "https://github.com/lazy-nevis/lazy-nevis/releases/tag/v0.1.0", draft: false, prerelease: false },
    ]), { status: 200 })));
  ...
  it("accepts only official release links and caches a successful result", async () => {
    const fetchMock = vi.fn().mockResolvedValue(new Response(JSON.stringify([
      ...
      { tag_name: "v0.2.0", html_url: "https://github.com/lazy-nevis/lazy-nevis/releases/tag/v0.2.0", draft: false, prerelease: false },
    ]), { status: 200 }));
    vi.stubGlobal("fetch", fetchMock);

    const expected = {
      version: "0.2.0",
      url: "https://github.com/lazy-nevis/lazy-nevis/releases/tag/v0.2.0",
    };
