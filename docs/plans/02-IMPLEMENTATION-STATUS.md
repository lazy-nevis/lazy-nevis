...
- CI-601 through CI-603: pinned toolchains/actions, frozen/locked installs, frontend/Rust/repository/PowerShell/dependency/CodeQL gates, and unsigned cross-platform smoke builds.
...
- INST-801 through INST-805: fail-closed shell/PowerShell installers, pinned/prerelease/dry-run/path modes, checksum/native signature checks, tests and mocked release selection primitives.
